...
class QPSK_channel_impairment(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "QPSK_channel_impairment")
        ...
        self.qpsk = qpsk = digital.constellation_rect([-1.07-1.07j, -1.07+1.07j, 1.07+1.07j, 1.07-1.07j], [0, 1, 3, 2],
        4, 2, 2, 1, 1).base()
...
def main(top_block_cls=QPSK_channel_impairment, options=None):
